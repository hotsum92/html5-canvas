...
export const drawCircle = (context: CanvasRenderingContext2D, canvas: HTMLCanvasElement) => {
  context.beginPath()
...
export const drawNumerals = (context: CanvasRenderingContext2D, canvas: HTMLCanvasElement) =>  {
...
export const drawCenter = (context: CanvasRenderingContext2D, canvas: HTMLCanvasElement) => {
  context.beginPath()
  context.arc(canvas.width/2, canvas.height/2, 5, 0, Math.PI*2, true)
  context.fill()
}

export const drawHands = (context: CanvasRenderingContext2D, canvas: HTMLCanvasElement) =>  {
  const date = new Date()
